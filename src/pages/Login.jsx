      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          <RoleCard
            ...
            onClick={() => handleRole(ROLES.LANDLORD)}
          />
          ...
          <RoleCard
            ...
            onClick={() => handleRole(ROLES.PROPERTY_MANAGER)}
          />
          ...
          <RoleCard
            ...
            onClick={() => handleRole(ROLES.BOOKKEEPER)}
          />
        </div>

        <div className="mt-14 text-center text-sm text-slate-500">
          <p className="font-medium">GOMO Properties</p>
          <p>Created by Natalie Mudavanhu</p>
        </div>
      </div>
    </div>
  );
